...
public struct SpeechTweak {
    ...
    /// Create a speech tweak whose effect varies by the values (from 0 to 100). Applies a different value within the range, depending on where you tap on the keyboard.
    ///
