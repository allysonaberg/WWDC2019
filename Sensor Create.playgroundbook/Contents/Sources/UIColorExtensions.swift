...
public extension UIColor {
    ...
    @nonobjc public convenience init(hue: Double, saturation: Double, brightness: Double, alpha: Double) {
        self.init(hue: CGFloat(hue), saturation: CGFloat(saturation), brightness: CGFloat(brightness), alpha: CGFloat(alpha))
    }
    
    @nonobjc public convenience init(red: Double, green: Double, blue: Double, alpha: Double) {
